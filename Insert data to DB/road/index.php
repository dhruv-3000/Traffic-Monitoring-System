...
<nav class="navbar navbar-inverse">
  ...
  <!-- Responsive Header -->
  <div class="container"> 
  <h2>Enter the Road details:-</h2>
  <br>
  <br>
  <form method="post" class="form-horizontal" action="save.php">  
    <div class="form-group">
      <label class="col-xs-3 control-label">Enter the Road ID:</label>
      <div class="col-xs-8">
        <input type="text" id="ROAD_ID" name="ROAD_ID" />       
      </div>
    </div>  
     <div class="form-group">
      <label class="col-xs-3 control-label">Enter the Traffic Point ID:</label>
      <div class="col-xs-8">
        <input type="text" id="TP_ID" name="TP_ID" />       
      </div>
    </div>  
    <div class="form-group">
      <label class="col-xs-3 control-label">Enter Road Location:</label>
      <div class="col-xs-8">
        <input type="text" id="ROAD_LOCATION" name="ROAD_LOCATION" data-role="tagsinput"  />        
      </div>
    </div>
    <div class="form-group">  
