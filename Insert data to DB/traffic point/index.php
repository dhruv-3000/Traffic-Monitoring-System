...
<nav class="navbar navbar-inverse">
  ...
  <!-- Responsive Header -->
  <div class="container" > 
  <h2>Enter the Traffic Point details:-</h2>
  <br>
  <br>
  <form method="post" class="form-horizontal" action="save.php">  
    ...
    <div class="form-group">
      <label class="col-xs-3 control-label">Enter the Status:</label>
      <div class="col-xs-8">
        <input type="text" id="STATUS" name="STATUS" data-role="tagsinput"  />        
      </div>
    </div>
    <div class="form-group">  
